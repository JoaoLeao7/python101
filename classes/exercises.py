...
class Triangle(object):
    ...
    def get_side_lengths(self, perimeter):
        def get_K(self,perimeter):
            sum_sin = math.sin(math.radians(self.angle1)) + math.sin(math.radians(self.angle2)) + math.sin(math.radians
            (self.angle3))
            return perimeter/sum_sin
            
        k = get_K(self,perimeter)
