...
def test_get_area(equilateral_triangle):
    assert equilateral_triangle.get_area(3) == 3.9
    assert equilateral_triangle.get_area(5) == 10.83
    assert equilateral_triangle.get_area(9) == 35.07
